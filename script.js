const texts = {
    hu: {
        ...
        edu: [
            "Magyar Tanítási Nyelvű Alapiskola – Deáki",
            "Jedlik Ányos Elektrotechnikai Szakközépiskola – Érsekújvár",
            "Selye János Egyetem – Alkalmazott informatika (Bc.) – Komárom",
            "Selye János Egyetem – Alkalmazott informatika (Mgr.) – Komárom"
        ],
    ...
    en: {
        ...
        edu: [
            ...
            "Selye János University – Applied Informatics (Bc.) – Komárno",
            "Selye János University – Applied Informatics (Mgr.) – Komárno"
        ],
