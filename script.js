const texts = {
    hu: {
        ...
        work: [
            "Telepítő – Gúta – Furbify s.r.o. (2 hét)",
            "Termékfotós – Gúta – Furbify s.r.o. (4 hét)"
        ],
    ...
    sk: {
        navbar: [
            "O mne", "Práca", "Vzdelanie", "Projekty", "Kontakt"
        ],
        ...
        work: [
            "Inštalatér – Kolárovo – Furbify s.r.o. (2 týždne)",
            "Produktový fotograf – Kolárovo – Furbify s.r.o. (4 týždne)"
        ],
        eduTitle: "Vzdelanie",
        edu: [
    ...
    en: {
        navbar: [
            "About", "Work", "Education", "Projects", "Contact"
        ],
        title: "Mgr. Márk Kovács",
        ...
        work: [
            "Installer – Kolárovo – Furbify s.r.o. (2 weeks)",
            "Product photographer – Kolárovo – Furbify s.r.o. (4 weeks)"
        ],
        eduTitle: "Education",
        edu: [
