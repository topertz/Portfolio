const texts = {
    hu: {
        ...
        work: [
            "Rendszer telepítő – Gúta – Furbify s.r.o.",
            "Termékfotós – Gúta – Furbify s.r.o."
        ],
    ...
    sk: {
        ...
        work: [
            "Inštalátor systému – Kolárovo – Furbify s.r.o.",
            "Produktový fotograf – Kolárovo – Furbify s.r.o."
        ],
        eduTitle: "Vzdelanie",
        edu: [
    ...
    en: {
        ...
        work: [
            "System installer – Kolárovo – Furbify s.r.o.",
            "Product photographer – Kolárovo – Furbify s.r.o."
        ],
        eduTitle: "Education",
        edu: [
